...
const char* device = "{\"deviceType\":\"LightingControl\",\"deviceCode\": \"lt05\",\"numberOfPorts\": 4, \"lights\": [{\"portId\": 1, \"dimmable\": true},{\"portId\": 2, \"dimmable\":  false},{\"portId\": 3, \"dimmable\":  false},{\"portId\": 4, \"dimmable\":  false}]}";
String device_id = "";
...
//  Serial.print("] ");
  ...
  if((String)topic == "authenticate/lt05"){
...
void checkMqttConnection() {
  ...
  if (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect("lt05", "lwt", 0, false, "lt05")) {
      Serial.println("connected");
      //client.publish("connected", "hello");\
      delay(10);
      client.subscribe("authenticate/lt05");
